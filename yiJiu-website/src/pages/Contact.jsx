            ...
            {subPages.map((item, index) => (
              <AnimatedSection key={index} delay={index * 0.05}>
                <Link to={item.href} className="block group">
                  <div className="bg-white rounded-xl p-6 border border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all text-center">
                    <div className="w-12 h-12 mx-auto bg-primary-50 rounded-xl flex items-center justify-center mb-3 group-hover:bg-primary-600 transition-colors">
        ...
        <div className="section-container">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <AnimatedSection>
                <div className="bg-gradient-to-br from-primary-900 via-primary-800 to-dark-900 rounded-2xl p-8 text-white h-full">
                  ...
                  <div className="mt-10 pt-8 border-t border-white/10">
                    <div className="w-32 h-32 bg-white rounded-lg mx-auto flex items-center justify-center text-gray-400 text-sm">
                      微信公众号<br/>二维码
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-2">
              <AnimatedSection delay={0.2}>
                <div className="bg-white rounded-2xl border border-gray-100 p-8 lg:p-10">
                  ...
                  <p className="text-gray-500 text-sm mb-8">请填写以下信息，我们会在收到您留言的一个工作日内给您回复。</p>

                  <form onSubmit={handleSubmit}>
                    {/* Inquiry Type */}
                    <div className="mb-6">
                      <label className="block text-sm font-medium text-gray-700 mb-3">咨询类型</label>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">任职岗位</label>
                        <input
                          type="text"
                          name="position"
                    ...
                    <div className="flex items-center gap-2 mb-8">
                      <input type="checkbox" id="agree" required className="w-4 h-4 text-primary-600 rounded" />
                      <label htmlFor="agree" className="text-sm text-gray-600">
                        我已阅读并同意 <span className="text-primary-600">隐私政策</span>
                      </label>
                    </div>
